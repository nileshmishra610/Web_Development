...
<head>
    ...
    <title>Home | Mishra IT company</title>
...
<body>
    <nav class="nav nav_top">
        <div class="logo">
            <a href="homeE.php"><img src="logm.jpg" height="60" width="25"></a>
        </div>
        <div class="nav_side">
           <a href="homeE.php">Home</a>
            <a href="userE.php">Employee Details</a>
    ...
    <div class="right">
    <h3 style="color:green;margin-left:70px;">MIT (Mishra IT Comapany)</h3>
